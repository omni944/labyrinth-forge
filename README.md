...
- parametrický SKÅDIS háček se souvislým nosným J-hákem a spodním stabilizačním kolíkem,
- SKÅDIS držák nástrojů s nastavitelnými otvory a dvěma nosnými J-háky,
- SKÅDIS polička s předním dorazem, dvěma J-háky a spodními stabilizátory,
- jednodílná vánoční CNC ozdoba se jménem, obvodovým rámem, očkem a osmi filigránovými motivy,
- nastavitelná šířka rámu a výrobních můstků; DXF a SVG obsahují vnější konturu a všechny vnitřní výřezy,
